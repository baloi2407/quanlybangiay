<div class="row">
    <div class="col-md-12 ">
        <div class="x_panel">
            ...
            <form class="form-horizontal form-label-left" method="post" action="<?= href('news', 'store') ?>" enctype="multipart/form-data">
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="profile_img">
                                <div id="crop-avatar">
                                    <!-- Current avatar -->
                                    <label for="">Hình ảnh bài viết</label><br>
                            ...
                            <div class="form-horizontal form-label-left">
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control" value="<?= post('name') ?? '' ?>" name="name" placeholder="Nhập tên bài viết">
                                ...
                                <div class="form-group row ">
                                    <label class="control-label col-md-3 col-sm-3 ">Nội dung <span class="text-danger">(*)</span></label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <textarea name="content" class="form-control" placeholder="Nội dung"><?= post('content') ?? '' ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <label class="control-label col-md-3 col-sm-3 ">Danh mục <span class="text-danger">(*)</span></label>
                                    <div class="col-md-9 col-sm-9 pt-2">
                                        <select name="category_id" id="" class="form-control">
                                            <option value="">Chọn danh mục</option>
                                            <?php
                                            foreach ($list_newscate as $newscate) {
                                            ?>
                                                <option value="<?= $newscate->id ?>"><?= $newscate->name ?></option>
