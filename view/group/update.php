<div class="row">
    <div class="col-md-12 ">
        <div class="x_panel">
            ...
            <form class="form-horizontal form-label-left" method="post" action="<?= href('group', 'update', ['id' => $item->id])  ?>" enctype="multipart/form-data">
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-horizontal form-label-left">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <textarea name="summary" class="form-control" placeholder="Tóm tắt nhóm quyền"><?= $item->summary ?? post('summary') ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row ">
