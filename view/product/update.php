<div class="row">
    <div class="col-md-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <?= $alert ?? '' ?>
                <form class="form-horizontal form-label-left" method="post" action="<?= href('product', 'update', ['id' => $item->id]) ?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-horizontal form-label-left">
                                ...
                                <div class="form-group row ">
                                    <label class="control-label col-md-2 col-sm-3 ">Giá <span class="text-danger">(*)</span></label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control" value="<?= $item->price ?? '' ?>" name="price" placeholder="Giá tiền">
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <label class="control-label col-md-2 col-sm-3 ">Giảm giá </label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control" value="<?= $item->promo ?? '' ?>" name="promo" placeholder="Giá tiền giảm giá">
                                    </div>
                                </div>
                                <div class="form-group row ">
                                ...
                                <div class="form-group row ">
                                    <label class="control-label col-md-2 col-sm-3 ">SKU <span class="text-danger">(*)</span></label>
                                    <div class="col-md-9 col-sm-9 ">
                                        <input type="text" class="form-control" value="<?= $item->sku ?? '' ?>" name="sku" placeholder="SKU của sản phẩm">
                                    </div>
                                </div>
                                <div class="form-group row ">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <select name="category_id" id="" class="form-control">
                                            ...
                                            <option selected value="<?= $item->category_id ?>"><?= (new category())->_item($item->category_id)->name ?></option>
                                            <?php
                                            foreach ($list_cat as $cat) {
                                                if ($cat->id != $item_category->id) {
                                            ?>
                                ...
                                <div class="form-group row ">
                                    <label class="control-label col-md-2 col-sm-3 ">Hãng sản xuất <span class="text-danger">(*)</span></label>
                                    <div class="col-md-9 col-sm-9 ">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        ...
                                        ?>
                                            <img class="img-fluid avatar-view" src="<?= getavatar($item_image->image) ?>" alt="Avatar" title="Change the avatar">
                                        <?php
                                        }
                                        ?>
                            ...
                            <div class="form-horizontal form-label-left">
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        ...
                                        <img class="img-fluid avatar-view" src="<?= getavatar($item->image_share) ?>" alt="Avatar" title="Change the avatar">
                                    </div>
                                </div>
                            </div>
                        </div>
