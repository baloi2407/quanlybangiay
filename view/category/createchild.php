<div class="row">
    <div class="col-md-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form class="form-horizontal form-label-left" action="<?= href('category', 'store_child', ['id' => $_GET['id']]) ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <a href="<?= href('category', 'index_child', ['id' => $_GET['id']]) ?>" type="button" class="btn btn-primary">Quay về</a>
