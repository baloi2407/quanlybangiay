<div class="row">
    <div class="col-md-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form class="form-horizontal form-label-left" action="<?= href('category', 'store') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="profile_img">
                                <div id="crop-avatar">
                                    ...
                                    <div class="form-horizontal form-label-left">
                                        ...
                                        <img class="img-fluid avatar-view" src="" alt="Avatar" title="Change the avatar">
