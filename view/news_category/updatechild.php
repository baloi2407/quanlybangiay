<div class="row">
    <div class="col-md-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form class="form-horizontal form-label-left" action="<?= href('newscategory', 'update_child', ['pid' => $item->parent_id, 'id' => $item->id]) ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-9 col-sm-9 mt-2">
                                    <select name="status" class="form-control">
                                        <option selected value="<?= $item->status ?>"><?= $item->status == 1 ? 'Hoạt dộng' : 'Khóa' ?></option>
                    ...
                    <div class="form-group">
                        <a href="<?= href('newscategory', 'index_child', ['id' => $item->parent_id]) ?>" type="button" class="btn btn-primary">Quay về</a>
