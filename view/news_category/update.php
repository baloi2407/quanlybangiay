<div class="row">
    <div class="col-md-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Cập nhật danh mục tin</h2>

                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <br>
                <form class="form-horizontal form-label-left" action="<?= href('newscategory', 'update', ['id' => $item->id]) ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <div class="form-group">
                            <a href="<?= href('newscategory', 'index') ?>" type="button" class="btn btn-primary">Quay về</a>
